DROP TABLE IF EXISTS USERS_ROLES_AUTHORITIES CASCADE;
DROP TABLE IF EXISTS USERS_ROLES CASCADE;
DROP TABLE IF EXISTS USERS_VALIDATION CASCADE;
DROP TABLE IF EXISTS USERS_AUTHORITY CASCADE;
DROP TABLE IF EXISTS USERS CASCADE;
DROP TABLE IF EXISTS SESSIONS CASCADE;
DROP TABLE IF EXISTS INSTANCES CASCADE;
DROP TABLE IF EXISTS BOP_ENTRY CASCADE;
DROP TABLE IF EXISTS BOP CASCADE;
DROP TABLE IF EXISTS CAR_ENTRY CASCADE;
...
DROP TABLE IF EXISTS ASSIST_RULES CASCADE;
