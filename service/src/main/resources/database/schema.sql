CREATE TABLE IF NOT EXISTS INSTANCES (
  ...
  DOCKER_IMAGE VARCHAR2(128 CHAR) NOT NULL,
...
CREATE TABLE IF NOT EXISTS SESSIONS (
  ...
  REFERENCES EVENT (SESSION_ID) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS CAR_ENTRY (
  ...
  CONSTRAINT FK1_CAR_ENTRY FOREIGN KEY (CAR_ENTRY_ID)
  REFERENCES CAR_ENTRIES (CAR_ENTRY_ID) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS DRIVER (
  ...
  REFERENCES CAR_ENTRY (DRIVER_ID) ON DELETE CASCADE
);
