...
```
java -jar -Ddocker.username=<your-system-username> acc-manager-0.5.0.jar
```
...
```
java -jar -Ddocker.username=<your-system-username> service/target/acc-manager-service-0.5.0.jar
```
